...
for i in RESIDUE_INDEXES:
    ...
    form_dict["occm_i_%i" %i]            = DecimalField(required=False, widget=HiddenInput(attrs={'class': 'include'}))
    form_dict["occscs_i_%i" %i]          = DecimalField(required=False, widget=HiddenInput(attrs={'class' : 'include'}))

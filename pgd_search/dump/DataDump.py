...
FIELDS = ['aa','a1','a2','a3','a4','a5','a6','a7','L1','L2','L3','L4','L5','ss','phi', 'psi', 'ome','omep', 'chi1','chi2','chi3','chi4','chi5', 'bm', 'bs', 'bg', 'occm', 'occscs', 'h_bond_energy', 'zeta']
...
RESIDUE_FIELDS =    ['a1','a1_i','a2','a2_i','a3','a3_i','a4','a4_i','a5','a5_i','a6','a6_i','a7',
                    ...
                    'ome_i', 'omep', 'omep_i', 'chi1','chi1_i','chi2','chi2_i','chi3','chi3_i','chi4','chi4_i', 'chi5','chi5_i', 'bm','bm_i','bs','bs_i','bg','bg_i', 'occm', 'occm_i', 'occscs', 'occscs_i', 'h_bond_energy','h_bond_energy_i', 'zeta','zeta_i']
for field in  sidechain_length_relationship_list:
